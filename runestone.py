...
class Runa:
    ...
    # TODO: Ветка к элементу даёт буст к нему
    #  Части Руны являются словами на искуственном языке, и эти слова можно соединять в предложения!
    #  !!! Части Руны с героев — это глаголы! Zalgo — write
